...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($image && $image['error'] === UPLOAD_ERR_OK) {
        ...
        $new_image = uploadImage($image, $product_name);
        if ($new_image) $image_name = $new_image;
    }
...
<head>
    <meta charset="UTF-8">
    <title>Karma Shop - Modifier le produit</title>
    <link rel="shortcut icon" href="img/fav.png">
    <meta name="author" content="CodePixar">
    <meta name="description" content="">
    <meta name="keywords" content="">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="single-product" style="padding:30px; margin-top:40px;">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="category_id" name="category_id" required>
                                ...
                                <?php foreach ($categories as $cat): ?>
                                    <option value="<?= $cat['Category_ID'] ?>" <?= ($cat['Category_ID'] == $product['id_category']) ? 'selected' : '' ?>>
